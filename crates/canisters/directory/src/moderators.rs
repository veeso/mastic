...
mod tests {
    ...
    use super::*;
    use crate::test_utils::{alice, setup};

    #[test]
    fn test_should_add_and_check_moderator() {
        setup();

        add_moderator(alice()).expect("should add moderator");

        assert!(is_moderator(alice()).expect("should check moderator"));
    }
    ...
    fn test_should_remove_moderator() {
        ...
        add_moderator(alice()).expect("should add moderator");
        remove_moderator(alice()).expect("should remove moderator");
